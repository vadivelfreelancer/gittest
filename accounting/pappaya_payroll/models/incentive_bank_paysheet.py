...
class IncentiveBankPaySheet(models.Model):
    _name = 'incentive.bank.paysheet'
    ...
    paysheet_line = fields.One2many('incentive.bank.paysheet.line','bank_paysheet_id', string='Paysheet Lines')
    ...
    def generate_paysheet(self):
        ...
        sequence_no = self.env['ir.sequence'].next_by_code('incentive.bank.paysheet') or _('New')
...
class ArrearPaysheetLine(models.Model):
    _name = 'incentive.bank.paysheet.line'

    bank_paysheet_id = fields.Many2one('incentive.bank.paysheet')

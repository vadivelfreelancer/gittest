    ...
    Sidebar.include({
        ...
        _redraw: function () {
            ...
            if (self.getParent().renderer.viewType == 'list') {
                ...
                self.$el.find('.export_treeview_pdf').on('click', self.on_sidebar_export_treeview_pdf);
            }
        },
        ...
        on_sidebar_export_treeview_xls: function () {
            ...
            session.get_file({
                ...
                data: {data: JSON.stringify({
                    model: data.view.modelName,
                    headers: data.export_columns_names,
        ...
        on_sidebar_export_treeview_pdf: function () {
            var self = this;
            var data = self.get_data();
